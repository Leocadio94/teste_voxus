<?php
    ...
    if (!empty($_POST)) {
        ...
        if ($valido) {
            ...
            Conexao::disconnect();
            header("Location: read_noticias.php");
        }
    }
?>
<!DOCTYPE html>
        ...
        <div class="container">
              ...
              <div class="row">
                <div class="col-lg-12">
                    ...
                    <form class="form-horizontal" action="create_noticias.php" method="post">
                        <div class="form-group <?php echo !empty($erroTitulo)?'error':'';?>">
                            ...
                            <div class="controls">
                                ...
                                <?php if (!empty($erroTitulo)): ?>
                                    <div class="alert alert-danger"><?php echo $erroTitulo;?></div>
                                <?php endif; ?>
                        ...
                        <div class="form-group <?php echo !empty($erroTexto)?'error':'';?>">
                            ...
                            <div class="controls">
                                ...
                                <?php if (!empty($erroTexto)): ?>
                                    <div class="alert alert-danger"><?php echo $erroTexto;?></div>
                                <?php endif;?>
                            </div>
                        </div>
